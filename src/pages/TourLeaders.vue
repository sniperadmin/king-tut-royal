  ...
  <AppLayout>
    <div class="container mx-auto p-4 pt-20">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div v-for="leader in tourLeaders" :key="leader.phone" class="bg-gray-900 border border-gray-800 group hover:border-yellow-400/50 transition-all duration-300 rounded-lg shadow-md p-6 flex flex-col items-center text-center text-white">
