<template>
  <BaseCard
    ...
    :to="post.internal ? { name: 'ArticlePage', params: { title: post.link.split('/').pop() }, query: { url: post.link } } : null"
    ...
    :hoverable="true"
    :group="true"
    customClass="block my-6 max-w-lg mx-auto"
...
<style scoped>
/* Add any specific styles for the ArticleCard here if needed */
</style>
