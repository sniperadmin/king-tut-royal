...
<template>
  <section class="py-12 bg-gray-900 text-white">
    <div class="container mx-auto px-4">
      <h2 class="text-4xl font-bold text-center mb-8 text-gold-500">Exclusive Video Showcase</h2>
      <div class="relative w-full max-w-4xl mx-auto rounded-lg overflow-hidden shadow-lg">
        <media-player
          ref="videoPlayer"
          class="aspect-video w-full bg-gray-600"
