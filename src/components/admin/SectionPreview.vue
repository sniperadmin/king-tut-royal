<template>
  <div class="section-preview" :style="sectionStyles">
    ...
    <div v-if="section.type === 'hero'" class="relative h-64 flex items-center justify-center">
      <div class="text-center text-primary-foreground z-10">
    ...
    <div v-else-if="section.type === 'content'" class="p-8">
      <div class="max-w-4xl mx-auto">
        <h2 v-if="section.content.title" class="text-3xl font-bold mb-6 text-foreground">
      ...
      <div class="max-w-6xl mx-auto">
        <div v-if="section.layout.columns === 2" class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p class="text-muted-foreground">{{ section.content.description || 'Description for your media section.' }}</p>
          </div>
          <div class="aspect-w-16 aspect-h-9 bg-muted rounded-lg flex items-center justify-center">
        ...
        <div v-else class="text-center">
          <div class="aspect-w-16 aspect-h-9 bg-muted rounded-lg flex items-center justify-center mb-6">
    ...
    <div v-else-if="section.type === 'gallery'" class="p-8">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <div v-for="i in 8" :key="i" class="aspect-square bg-muted rounded-lg flex items-center justify-center">
    ...
    <div v-else-if="section.type === 'features'" class="p-8">
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-12">
          ...
          <p class="text-muted-foreground">{{ section.content.subtitle || 'Feature section subtitle' }}</p>
        </div>
    ...
    <div v-else-if="section.type === 'cta'" class="p-8">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <p class="text-xl text-muted-foreground mb-8">{{ section.content.description || 'Compelling call to action description.' }}</p>
        <button class="bg-primary text-primary-foreground px-8 py-4 rounded-lg text-lg font-semibold hover:bg-primary-hover">
      ...
      <div class="max-w-4xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <div class="space-y-4">
              <div class="flex items-center">
                <svg class="h-5 w-5 text-muted-foreground mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div class="bg-muted rounded-lg p-6">
            <div class="space-y-4">
              <div>
                <div class="h-4 bg-border rounded w-1/4 mb-2"></div>
                <div class="h-10 bg-background rounded border border-input"></div>
              </div>
              <div>
                <div class="h-4 bg-border rounded w-1/3 mb-2"></div>
                <div class="h-10 bg-background rounded border border-input"></div>
              </div>
              <div>
                <div class="h-4 bg-border rounded w-1/4 mb-2"></div>
                <div class="h-24 bg-background rounded border border-input"></div>
              </div>
    ...
    <div v-else class="p-8 text-center">
      <div class="max-w-2xl mx-auto">
        ...
        <p class="text-muted-foreground">Section preview will appear here</p>
      </div>
    </div>
  </div>
</template>
