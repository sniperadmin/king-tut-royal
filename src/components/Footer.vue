    ...
    <div class="mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div class="col-span-1 md:col-span-2">
          ...
          <nav aria-label="Social media" class="flex justify-center space-x-4">
        ...
        <div>
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-center">
              ...
              <a href="https://wa.me/971585923054" class="text-muted-foreground hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary transition-colors" target="_blank" rel="noopener" aria-label="WhatsApp">+971585923054</a>
            </div>
            <div class="flex items-center justify-center">
