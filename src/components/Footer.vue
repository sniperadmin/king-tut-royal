<template>
  <footer class="bg-light-blue text-foreground py-8 flex flex-col justify-between" role="contentinfo" aria-label="Site Footer">
        ...
        <div>
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-start">
              <svg class="w-5 h-5 text-primary mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center">
              <svg class="w-5 h-5 text-primary mr-3" fill="currentColor" viewBox="0 0 24 24">
